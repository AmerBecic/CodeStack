...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class CategoryItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CategoryId,MediaTypeId,DateItemReleased")] CategoryItem categoryItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CategoryId,MediaTypeId,DateItemReleased")] CategoryItem categoryItem)
        {
