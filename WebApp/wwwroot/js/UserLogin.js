$(function () {
    var loginButton = $("#UserLoginModal button[name='login']").click(onUserLoginClick);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (hasErrors == true) {
                    ...
                    loginButton = $("#UserLoginModal button[name='login']").click(onUserLoginClick);
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                ...
                ShowAlert("#alert_placeholder_login", "danger", "Error!", errorText);
